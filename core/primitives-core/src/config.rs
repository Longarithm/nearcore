...
pub struct ExtCostsConfig {
    ...
    #[serde(default = "default_read_memory_trie_node")]
    pub read_memory_trie_node: Gas,
...
pub fn default_read_memory_trie_node() -> Gas {
...
impl ExtCostsConfig {
    pub fn test() -> ExtCostsConfig {
        ExtCostsConfig {
            ...
            read_memory_trie_node: default_read_memory_trie_node(),
...
impl ExtCosts {
    pub fn value(self, config: &ExtCostsConfig) -> Gas {
        ...
        match self {
            ...
            read_memory_trie_node => config.read_memory_trie_node,
