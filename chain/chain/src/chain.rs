...
use near_store::DBCol::ChunkExtra;
...
impl Chain {
    ...
    fn get_shard_info(
        ...
        Ok(ShardApplyInfo {
            ...
            cares_about_shard_next_epoch: self.shard_tracker.will_care_about_shard(
                me.as_ref(),
                prev_hash,
                shard_id,
                true,
            ),
            will_shard_layout_change: self.epoch_manager.will_shard_layout_change(prev_hash)?,
        })
    }
    ...
    fn apply_chunk(
        ...
        match apply_chunk_type {
            ApplyChunkType::YesNew(chunk) => Self::apply_new_chunk(
                parent_span,
                block_context,
                chunk,
                shard_uid,
    ...
    fn apply_split_state_chunk(
        ...
        let next_epoch_shard_layout =
            epoch_manager.get_shard_layout(&block_context.next_epoch_id)?;
