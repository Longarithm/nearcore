...
class NeardRunner:
    ...
    def configure_log_config(self):
        default_log_filter = 'epoch_manager=debug,chunk_validation=debug,runtime=debug,client=debug,chain=debug,mirror=debug,actix_web=warn,mio=warn,tokio_util=warn,actix_server=warn,actix_http=warn,info'
